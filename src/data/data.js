...
export const artists = [
    ...
    },
    {
        ...
        "name": "Ipin",
        "description": [
            "Ipin alias Germain Prevost est un street artiste français né à Reims en 1981.",
            "Ipin, c’est la contraction de “il peint” et c’est ce que commence à faire régulièrement l’artiste au début des années 2000 dans des friches industrielles de La Ciotat tout en menant un master en Environnement et Société.",
            "Se formant seul à l’art et inspiré de divers artistes comme Vasarely et ses formes géométriques ou EastEric, Ipin cherche la rupture dans les espaces publics, là où le linéaire débloque et propose à travers ces œuvres un regard engagé sur notre environnement. En 2017, il initie la création du “MUR du fond” à La Cité des Arts de la Rue à Marseille : un grand mur qui laisse libre court à l’imagination et l'expérimentation d’un artiste le temps d’une soirée.",
            "Aujourd’hui éloigné des codes du graffiti, Ipin s’axe autour de l’art conceptuel et nous fait découvrir de nouvelles notions comme l’impactivisme (auto-proclamé) : “la forme la plus basique de réappropriation graphique de l’espace public. En quelque sorte, un graffiti déshabillé de tout apparat décoratif, pour n’en garder que les composantes essentielles : un mouvement, une couleur, une forme et un support.”"
        ],
